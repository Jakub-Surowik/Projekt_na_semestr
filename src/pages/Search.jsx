    ...
    <>
      <div className="container" style={{ padding: "60px 0" }}>
        ...
        <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
          <div style={{ flex: selected ? '0 0 42%' : '1', minWidth: 240, transition: 'all 0.3s ease', maxHeight: '80vh', overflowY: 'auto' }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12 }}>
              {lawyers
                ...
                .map(l => (
                  ...
                  >
                    <h4 style={{ margin: '0 0 6px' }}>{l.firstName} {l.lastName}</h4>
                    <small>{l.role}</small>
                    {l.specialization && l.specialization.length > 0 && (
                      <p style={{ fontSize: 12, margin: '6px 0 0' }}>{l.specialization.join(', ')}</p>
                    )}
                  </div>
                ))}
            </div>
          ...
          {selected && (
            <div style={{ flex: '0 0 55%', minWidth: 360, maxHeight: '80vh', overflowY: 'auto' }}>
